...
| C041 | goauthentik/authentik #25476 → [#26111](https://github.com/goauthentik/authentik/pull/26111) | Go+Python/identidad-SSO (25.5k★) | 🟡 **APROBADO, adoptado por el maintainer** — `login_hint` loop "Not You?"; fix en `CancelView`. **Jens Langhammer (fundador) commiteó en la rama (cleanup/refactor) y aprobó** → lo está mergeando él. NO force-pushear (pisaría su trabajo). Merge #10 encaminado | — | — |
