...
| 📤 PRs enviados (reales) | **37** (7 🟢 · 20 🟡 en review · 10 🔴 cerrados) + unavatar código mergeado vía #661 (sin crédito) |
...
| Contribuciones en `active/` | **19 en review** (airi #2414/#2415 + delta/mystmd/soldeer/harper/RustPython/sktime/aeon/image/statsforecast/coreutils/git-cliff/sed/numbat/jq/gum + **Daft #7508/sail #2580/nushell #19021 nuevos**); onefetch/tract/findutils/diplomat mergeados; AMICI/nannou/yq cerrados | en review |
